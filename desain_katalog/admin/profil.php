...
<?php
  ...
  $id_user = $_SESSION['id_user'];
    ...
    //get profil
    $sql = "select `nama`, `email`,`foto`, `level` from `user` where `id_user`='$id_user'";
    //echo $sql;
            ...
            <div class="card">
              <div class="card-header">
                <div class="card-tools">
                  <a href="editprofil.php" class="btn btn-sm btn-info float-right" name="level" value="<?php $level?>"><i class="fas fa-edit"></i> Edit Profil</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
