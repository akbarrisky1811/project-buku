      ...
      <form class="form-horizontal" method="post" action="konfirmasitambahuser.php" enctype="multipart/form-data">
        <div class="card-body">
          <div class="form-group row">
            ...
            <i class="fas fa-user-circle"></i> <u>Data User</u></span></label>
          </div>          
          <div class="form-group row">
        ...
        <div class="card-footer">
          <div class="col-sm-12">
            <button type="submit" name="submit" class="btn btn-info float-right"><i class="fas fa-plus"></i> Tambah</button>
          </div>  
        </div>
        <!-- /.card-footer -->
      </form>
